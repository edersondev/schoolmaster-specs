...
- **FR-019**: Stale worker completions for canceled, deleted, restored, superseded, or otherwise terminal report runs MUST be ignored and audited without publishing outputs or mutating generation status.
