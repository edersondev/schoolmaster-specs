...
- Approved platform/support OpenAPI operations may need promotion into `specs/api/openapi.yaml` and the platform contract mirror before frontend implementation can consume them.
