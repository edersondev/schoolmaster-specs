...
- `logoPath`: Nullable backend-managed path/reference to the stored school logo.
- `logoUrl`: Nullable browser-ready URL generated by the backend for displaying
  the stored school logo.
