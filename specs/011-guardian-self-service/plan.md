...
- Guardian self-service proof requires an explicit school-administrator-created guardian-user link plus an active same-school guardian-student association.
