...
- Visible labels, filenames, validation messages, diagnostics, report columns, and test output must not expose raw answer text, uploaded file contents, storage paths, answer keys, private grading notes, credentials, full payloads, or unauthorized record existence.
...
- **FR-016**: The teacher and school-administrator review UI MUST list and filter submitted responses by approved status, grading status, scan status, assignment context, and safe student identity fields.
...
- **FR-020**: The grading UI MUST hide private grading notes, hidden answer keys, rubric internals, private file storage paths, scanner internals, full payloads, and unauthorized cross-tenant identifiers from visible UI, diagnostics, and test output.
...
- **AssessmentReviewQueueView**: Teacher or school-administrator view of submitted advanced responses, review filters, scan states, grading states, and safe student context.
...
- **SC-010**: 100% of tested visible UI, diagnostics, labels, filenames, report fields, and automated test output omit raw answer text where not explicitly student-visible, uploaded file contents, private storage paths, answer keys, private grading notes, credentials, full payloads, and unauthorized cross-tenant details.
